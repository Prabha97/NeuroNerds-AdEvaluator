demo = {
  ...
  initDocumentationCharts: function() {
    if ($('#dailySalesChart1').length != 0 && $('#websiteViewsChart1').length != 0) {
      /* ----------==========     Daily Sales Chart initialization For Documentation    ==========---------- */
      ...
      var animationHeaderChart1 = new Chartist.Line('#websiteViewsChart1', dataDailySalesChart1, optionsDailySalesChart1);
    }
  },
  ...
  initDashboardPageCharts1: function() {

    if ($('#dailySalesChart1').length != 0 || $('#completedTasksChart1').length != 0 || $('#websiteViewsChart1').length != 0) {
      /* ----------==========     Daily Sales Chart initialization    ==========---------- */
