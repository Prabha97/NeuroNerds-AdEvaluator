                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <!-- <div>
                                                <table style="width: 800px">
                                                    ...
                                                    <tr>
                                                        <td>Enter User ID :</td>
                                                        <td><input id="userId" type="text"  style="border-style: none; background-color: #e2e3e5" size="50"
                                                                   value="" ></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input id="uname" type="text" style="border-style: none ; background-color: #e2e3e5" size="50" value=""
                                                                   ></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Advertisement Name:</td>
                                                        <td><input id="adname" type="text" style="border-style: none ; background-color: #e2e3e5" size="50" value=""
                                                            ></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Advertisement Category:</td>
                                                        <td><input id="adcategory" type="text" style="border-style: none ; background-color: #e2e3e5" size="50" value=""
                                                            ></td>
                                                        <td><label id="validate" style="border-style: none ; background-color: #a71d2a"></label></td>
                                                    </tr>
                                                    <tr></tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="card-body">Upload CSV : &nbsp; <input type="file" id="Approvers_CSV"  name="Approvers_CSV">
                                            </div> -->
                                            <div class="col-lg-6">
                                        ...
                                        <div class="card-body">
                                            <div>
                                                <table style="width: 800px">
                                                    <tbody>
                                                    <tr>
                                                        <td>Enjoyed Efficacy Score:</td>
                                                        <td><input id="enjoyescore" type="text"  style="border-style: none" size="50"
                                                                   value="" disabled></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Non-Enjoyed Efficacy Score:</td>
                                                        <td><input id="enjoyescore2" type="text"  style="border-style: none" size="50"
                                                                   value="" disabled></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Status:</td>
...
<!-- <script>
    ...
    $(document).ready(function () {
        //Approvers.CSV file upload function
        document.getElementById("validate").value= "";
        $('#upload_csv').on("submit", function (e) {

            if (!confirm("Make sure you upload correct EEG Data File ??")) {
                return false;
            } else {
                var userid,username,adname,adcategory;
                ...
                if (userid != "" && username != "" && adname != "" && adcategory != "") {
                    ...
                    var myfile = $('#Approvers_CSV').val();
                    var ext = myfile.split('.').pop();

                    if (ext === 'csv') {
                        var file = $('#Approvers_CSV').val();
                        var form = $('#upload_csv')[0];
                        console.log(form);
                        var data = new FormData(form);
                        var uploadFile = 'approvers.csv';
                        console.log(data);
                        $.ajax({
                            url: "uploadCSV.php",
                            method: "POST",
                            data: data,
                            contentType: false,
                            async: false,// The content type used when sending data to the server.
                            cache: false,                // To unable request pages to be cached
                            processData: false,
                            success: function (response) {
                                console.log("sucsess " + response);
                                console.log("upload test_approvers.csv file");
                                validateCSV(); //validate uploaded file by call finance-api
                                document.getElementById("Approvers_CSV").value = "";
                    ...
                    //bootbox.alert("Fill All Required fields");
...
<script>
    // validate the csv file and collect data from API using AJAX
            ...
            success: function (data) {
                ...
                var mixedChart = new Chart(vtx, {
                    ...
                    data: {
                        datasets: [{
                            ...
                            label: "Bar",
                            backgroundColor: ["rgba(51, 110, 123, 1)", "rgba(51, 110, 123, 1)", "rgba(51, 110, 123, 1)", "rgba(51, 110, 123, 1)", "rgba(2,117,216,1)",
                        ...
                        //     label: "Line",
                        //     lineTension: 0.3,
                        //     backgroundColor: "rgba(216,31,16,0.2)",
                        //     borderColor: "rgb(216,48,53)",
                        //     pointRadius: 5,
                        //     pointBackgroundColor: "rgb(216,47,61)",
                        ...
                        labels: ["Happy","Neutral","Sad","Satisfying"]
               ...
               // display enjoyment data on pie chart
                ...
                var myPieChart = new Chart(enj, {
                    type: 'doughnut',
                    data: {
                        labels: ["Non enjoyed efficiency", "Enjoyed efficency"],
                        datasets: [{
                            data: enjoyment_score,
                            backgroundColor: ['#456990', '#49DCB1'],
                        }],
                    },
                });
                document.getElementById("enjoyescore").value = Enjoye.toFixed(2)+"%";
                document.getElementById("enjoyescore2").value = (100-Enjoye).toFixed(2)+"%";
