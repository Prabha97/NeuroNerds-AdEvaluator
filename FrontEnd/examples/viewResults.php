...
if(isset($_POST['but_add_user'])){
  ...
  if(!empty($_POST['movie_name']) && !empty($_POST['username'])){

    //$files = scandir('C:\Users\Lenovo\Dropbox\EEG', SCANDIR_SORT_ASCENDING);
    //$newest_file = $files[0]; 
    //$filePath = 'C:/Users/Lenovo/Dropbox/EEG/'.$newest_file;
    //echo "<h2>" . $filePath . "</h2>";
    ...
    $query_userId = "SELECT user_id FROM users WHERE username = '".$username."'";
    $result_userId = mysqli_query($con, $query_userId);
    $row = mysqli_fetch_assoc($result_userId);
    $userId =  $row['user_id'];

    $query_movieId = "SELECT movieId FROM movies WHERE movie_name = '".$add_user_name."'";
    $result_movieId = mysqli_query($con, $query_movieId);
    $row = mysqli_fetch_assoc($result_movieId);
    $movieId =  $row['movieId'];

    $queryAddScore = "INSERT INTO userscores(userId,movieId) VALUES('".$userId."','".$movieId."')";
    ...
    $run3 = mysqli_query($con,$queryAddScore) or die(mysqli_error($con));
      ...
      <div class="content">
        ...
        <a href="videos.php"> Back </a><br>
          <div class="row">
            ...
            <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">Add User Records</h4>
                  <!--<p class="card-category">Add User Details</p>-->
                </div>
                <div class="card-body">
                  ...
                  <form method="post" action="" enctype='multipart/form-data'>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <select class="form-control select2" name="username">
                            <?php
                            $records = mysqli_query($con, "SELECT user_id,username From users");  // Use select query here 
                      ...
                      <div class="col-md-12">
                        ...
                        <!--<div class="col-md-12">
                            <div class="form-group">
                            <label class="bmd-label-floating">Movie_Name</label>
                      ...
                      <?php 
                        $dir = 'C:/Users/Lenovo/Dropbox/';
                        $files = scandir('C:\Users\Lenovo\Dropbox', SCANDIR_SORT_DESCENDING);
                        $b = scandir($dir,1);
                        $newest_file1 = $b[0];
                        $newest_file = $files[0]; 
                        $filePath = 'C:/Users/Lenovo/Dropbox/'.$newest_file;
            ...
            <!--<a href="charts.php"> View Charts </a><br>
            <button style="background-color: #27ae60 " href="charts.php" class="btn btn-primary pull-left">Add User</button>-->
            <form action="Attention.php">
                <input type="submit" value="View Analysis" />
            </form>
            <form action="charts.php">
