    ...
    <div class="main-panel">
      <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="Approvers" role="tabpanel" aria-labelledby="Approvers-tab" style="width:85%">
                                <br>
                            ...
                            <div class="row" style='margin-left: 5px;'>
                                <div class="col-xl-5">
                                    <div class="card mb-4">
                                        <div class="card-header"><i class="fas fa-chart-bar mr-1"></i> Attention Score (%)
                                        </div>
                                        <div class="card-body">
                                            <div>
                                        ...
                                        <div class="card-body">
                                            <div>
                                                <table style="width: 800px">
                                                    ...
                                                    <tr>
                                                        <td>Status:</td>
                                                        <td><input id="high_score_status" type="text" style="border-style: none" size="50" value=""
                                                                   disabled></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
    ...
    
     {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //let attention= [score,medium_score,low_score,score_val];
                //let a_score = Math.max(score,medium_score,low_score,score_val).toFixed(2);
                ...
                let high_score_status = data['600'];
                ...
                let e_status= high_score_status;
                ...
                //document.getElementById("high_score").value = parseFloat(high_score).toFixed(2)+"%";
                document.getElementById("high_score_status").value = high_score_status;
                //clear list data
                delete data["100"];
                delete data["200"];
                delete data["300"];
                ...
                let ej_score= parseFloat(not_enjoy).toFixed(2);
                let ej_status;
                if(ej_score> 50.00){
                    ej_status= "Excellent";
                }
               ...
               // display enjoyment data on pie chart
                ...
                //document.getElementById("enjoyescore").value = (100-Enjoye).toFixed(2)+"%";
                //document.getElementById("enjoyescore2").value = Enjoye.toFixed(2)+"%";
