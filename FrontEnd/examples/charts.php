  ...
  <script>
    ...
    <script>
      ...
      function reloadChartData(){
        ...
        if (document.getElementById('CSVFile').files.length>0){
          readInputFile(document.getElementById('CSVFile').files[0]);
        }
      }
  ...
  <section class="patterned">
      <div class="container">
        ...
        ?>
                ...
                <?php       
                  $fetchVideos = mysqli_query($con, "SELECT csvFilePath FROM userrecords ORDER BY user_id DESC LIMIT 1");
                  while($row = mysqli_fetch_assoc($fetchVideos)){
                    //$movie_id = $row['id'];
                    //$name = $row['movie_name'];
                    //$genre = $row['movie_genre'];
                    //$year = $row['movie_year'];
                    $location = $row['csvFilePath'];

                    //echo "<div style='float: left; margin-right: 5px; margin-left: 15px;'>
                    //      <file src='".$location."'></file><br>";

                    //echo "<h2>" . $location . "</h2>";

                    //echo "<span><a href='watchVideo.php?movieId=" . $row['id'] . "' target='_blank' >".$name."</a></span>";
                    //echo "    ";
                    //echo "(";
                    //echo  "<span>".$year."</span>";
                    //echo ")<br>";
                    ///echo "<span>".$genre."</span><br>
                ...
                ?>
                      ...
                      <?php 
                        ...
                        //echo '<input id="CSVFile" name="CSV File" value="'.$filePath.'">'
                      ?>

        <!--<p>Select Mind Monitor CSV recording: <input id="CSVFile" value="C:\Users\Lenovo\Dropbox\museMonitor_2021-09-11--01-25-58_9145199830808311087.csv" name="CSV File"/></p>-->
        
         
        <!--<p>Select Mind Monitor CSV recording: <input id="CSVFile" type="file" class="btn btn-outline btn-xl inline" value="C:/Users/Lenovo/Dropbox/museMonitor_2021-09-11--01-25-58_9145199830808311087.csv"  name="CSV File"/></p>
                  <input type="file" value="C:/Users/Lenovo/Dropbox/museMonitor_2021-09-11--01-25-58_9145199830808311087.txt" >-->
        <blockquote>
